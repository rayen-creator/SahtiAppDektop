 ...
 * @author Akrimi
 */
public class AfficherAvisNutritionnisteController implements Initializable {
    ...
    @FXML
    private TableColumn<Avis, String> colNutritionniste;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        colNutritionniste.setCellValueFactory(new PropertyValueFactory<>("nutritionniste"));
        colCommentaire.setCellValueFactory(new PropertyValueFactory<>("Commentaire"));
           // Display row data
        ObservableList<Avis> list = ac.afficherAvis("idNutritioniste");
        table.setItems(list);
    }    
    @FXML
    ...
    @FXML
    private void deleteAvisNutritionniste(ActionEvent event) {
        Alert alert = new Alert(Alert.AlertType.WARNING);
        alert.setTitle("Supprimer avis Nutritionniste");
        // Header Text: null
        alert.setHeaderText(null);
        alert.setContentText("Voulez vous vraiment supprimer l'avis sur le nutritionnite!");
        alert.showAndWait();
    }
