 ...
 * @author Rayen
 */
public class SignupNutriController implements Initializable {
    ...
    @FXML
    private TextField idconfirmpwd;
    @FXML
    private TextField idcertif;
    @FXML
...
//    private String filepath;
    ...
    @FXML
    private void SignupN(ActionEvent event) {
        String nom = idnom.getText();
        String prenom = idprenom.getText();
        String addr = idaddr.getText();
        String cert = idcertif.getText();
        ...
        try {
            if ((nom.isEmpty()) & (prenom.isEmpty()) & (addr.isEmpty()) & (cert.isEmpty()) & (bio.isEmpty()) & (mail.isEmpty()) & (pwd.isEmpty()) & (imgp.toString().isEmpty())) {
                ...
                Nutritioniste n = new Nutritioniste(nom, prenom, mail, pwd, addr, bio, cert, file);
                Signup s = new Signup();
                ...
                if (Integer.parseInt(txt_CodeConfirmation) == nb_valider) {
                    ...
                    if (s.signupNutritioniste(n) == true) {
